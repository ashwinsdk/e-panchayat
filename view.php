...
$id=$_GET["griveance_id"];
   if(isset($_POST["disapprove"])){
     $sql2 = "UPDATE griveance SET gstatus='Disapporved' WHERE griveance_id='$id'";
...
if(isset($_POST["approve"])){
  $sql2 = "UPDATE griveance SET gstatus='Approved' WHERE griveance_id='$id'";
  $run = mysqli_query($conn , $sql2);
  if($run){
    if($run){
      header("Refresh:0");
        ...
        <main class="flex-shrink-0">
           ...
           <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    <a class="navbar-brand" href="admin-home.php">Sarpanch</a>
                </div>
            </nav>
            <!-- Header-->
            <header class="py-5">
              ...
              <div class="card-body">
                ...
                <h2 class="card-title">Sarpanch Action</h2>
                <div class="table-responsive">
                ...
                <!-- End Table with stripped rows -->
                                ...
                                <a class="btn btn-round-primary btn-lg" href="admin-home.php">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
